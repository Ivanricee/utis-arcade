...
export const LEFT_FLOAT_CENTER: [number, number, number] = [-0.474, 2.68, 0.825]

export const CENTER_FLOAT_CENTER: [number, number, number] = [-0.65, 2.68, 0.15]
export const RIGHT_FLOAT_CENTER: [number, number, number] = [-0.4738, 2.68, -0.825]
